  ...
  >
    <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
      ...
      >
        <svg 
          class="w-5 h-5 mb-2 transition-colors duration-200"
          :class="isActive('map') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500'"
          aria-hidden="true" 
          xmlns="http://www.w3.org/2000/svg" 
          fill="none" 
          viewBox="0 0 24 24"
      ...
      >
        <svg 
          class="w-5 h-5 mb-2 transition-colors duration-200"
          :class="isActive('calendar') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500'"
          aria-hidden="true" 
          xmlns="http://www.w3.org/2000/svg" 
          fill="none" 
          viewBox="0 0 24 24"
